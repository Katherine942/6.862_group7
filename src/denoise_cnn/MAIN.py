...
def main(json_path='train_dncnn7.json'):
    ...
    for epoch in range(1000):  # keep running
        for i, train_data in enumerate(train_loader):
            ...
            if dataset_type == 'dnpatch' and current_step % 200000 == 0:  # for 'train400'
            ...
            if current_step % opt['train']['checkpoint_test'] == 0:
                ...
                logger.info('<epoch:{:3d}, iter:{:8,d}, Average MSE : {:<.2f}\n'.format(epoch, current_step, avg_mse))
                logger.info('<epoch:{:3d}, iter:{:8,d}, Average RMSE : {:<.2f}\n'.format(epoch, current_step, avg_rmse))
